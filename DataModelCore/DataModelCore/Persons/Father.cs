...
namespace DataModelCore.Persons
{
    ...
    public class Father
    {
        ...
        [NotMapped]
        public Image PersonalPhoto { get => PhotoData != null ? new Image(new MemoryStream(this.PhotoData)) : null; }


        [NotMapped]
        public Image DeathCertificateImage { get => DeathCertificatePhotoData != null ? new Image(new MemoryStream(this.DeathCertificatePhotoData)) : null; }
